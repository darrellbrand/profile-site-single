            ...
            <div className="flex flex-col md:flex-row relative  items-stretch justify-center w-full gap-5 pb-10 ">
                <Card className=" w-full items-center">
                    ...
                    <CardContent className=" justify-center flex-1">
                        <img
                            src="/profile-site-static/images/Screenshot_20250411_134037.png"
                ...
                <Card className="w-full items-center ">
                    ...
                    <CardContent className="justify-center ">
                        ...
                        <img
                            src="/profile-site-static/images/Screenshot_20250411_134214.png"
                            alt="Landing page preview"
                            className=" max-w-xs w-full object-cover"
                        />
                    </CardContent>
                ...
                <Card className="w-full items-center">
                    ...
                    <CardContent className="justify-center">
                        ...
                        <img
                            src="/profile-site-static/images/Screenshot_20250411_134127.png"
                            alt="Landing page preview"
                            className=" max-w-xs w-full  object-cover"
                        />
                    </CardContent>
