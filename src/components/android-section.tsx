...
export default function AndroidSectionOne() {
    return (
        <section id="android" className="relative w-full max-w-7xl mx-auto  my-10">
                ...
                <h1 className=" mx-10 my-15 text-2xl font-bold dark:text-neutral-200 md:text-4xl lg:text-7xl text-slate-500 ">Recipe king android app</h1>
                <div className="flex flex-col md:flex-row relative items-center justify-center w-full gap-5   mx-auto  ">
                    ...
                    <Card className="w-full items-center">
                        <CardHeader className="w-full text-4xl">
                            ...
                            <CardDescription className="text-2xl mb-20">Search our database of recipes.</CardDescription>
                        </CardHeader>
                        <CardContent className="justify-center">
