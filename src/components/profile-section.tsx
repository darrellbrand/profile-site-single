...
export default function ProfileSectionOne() {
    return (
        <section id="profile">
            <div className="w-full flex   bg-neutral-300/80 dark:bg-neutral-800/80">
                <div className="w-full relative flex justify-center mx-auto pt-10 mb-10 pb-5  ">
                    ...
                    <div className="flex flex-col w-full p-5 gap-5 mx-auto  ">
                        <h1 className=" text-center text-2xl font-bold dark:text-neutral-100 md:text-4xl lg:text-7xl text-slate-500 self-start mx-5">About</h1>
