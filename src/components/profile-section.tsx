                    ...
                    <div className="flex flex-col w-full  gap-5 pb-10   mx-auto max-w-7xl ">
                        ...
                        <Card className=" w-full items-center px-5 pt-10  bg-neutral-300/80 dark:bg-neutral-600 ">
                            <div className="w-full  text-2xl ">
                                <h1 className="pb-5 text-center whitespace-normal sm:whitespace-nowrap sm:overflow-hidden sm:text-ellipsis text-3xl  font-bold dark:text-neutral-100 md:text-4xl lg:text-6xl text-neutral-600 ">Darrell Friday - Software Engineer</h1>
                            </div>
